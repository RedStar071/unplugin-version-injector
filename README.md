...
and at the moment esbuild will no longer pass the file to be processed by
...
- Import from bundler-specific entry points (e.g., `unplugin-version-injector/vite`, `unplugin-version-injector/esbuild`)
